...
class NeckTargetJointPublisher(Node):
    """
    This class is used to publish the joint states of the Robotic Neck target position to applay the inverse kinematics for control
    """
    def __init__(self):
        super().__init__('neck_target_joint_publisher')
        self.set_params()
        self.config_params()
        ...
        self.joint_publisher = self.create_publisher(JointState, 'target/joint_states', 10)
    ...
    def config_params(self):
        roll_param_descriptor = ParameterDescriptor(
            ...
            read_only=False,
            integer_range=[IntegerRange(from_value=-25, to_value=25, step=1)])
